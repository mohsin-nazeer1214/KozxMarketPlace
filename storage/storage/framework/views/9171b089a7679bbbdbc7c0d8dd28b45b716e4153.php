...
Kozx  </title>
  ...
  <!-- bootstrap core css -->
  <link rel="stylesheet" type="text/css" href="<?php echo e(url('front_assets/css/bootstrap.css')); ?>" />

  <!-- Custom styles for this template -->
  <link href="<?php echo e(url('front_assets/css/style.css')); ?>" rel="stylesheet" />
  <!-- responsive style -->
  <link href="<?php echo e(url('front_assets/css/responsive.css')); ?>" rel="stylesheet" />
    ...
    <header class="header_section">
      <nav class="navbar navbar-expand-lg custom_nav-container ">
        ...
        <a class="navbar-brand" href="index.html">
          <img src="<?php echo e(url('front_assets/images/logo.jpeg')); ?>" alt="Giftos Logo">
        </a>
          <ul class="navbar-nav  ">
          ...
          <div class="user_option">
            <a href="<?php echo e(url('login')); ?>" class="login-btn">
...
<div class="container">
  ...
  <div class="container-row slideFirst">
    <div class="image-container">
      <img src="<?php echo e(url('front_assets/images/logo.jpeg')); ?>" alt="Image 1">
    </div>
    <div class="image-container">
      <img src="<?php echo e(url('front_assets/images/logo.jpeg')); ?>" alt="Image 2">
    </div>
    <div class="image-container">
      <img src="<?php echo e(url('front_assets/images/logo.jpeg')); ?>" alt="Image 3">
    </div>
    <div class="image-container">
      <img src="<?php echo e(url('front_assets/images/logo.jpeg')); ?>" alt="Image 3">
    </div>
      ...
      <div class="d-flex">
        ...
        <div class="container-row card-outer"style="gap:20px;">
          <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="">
              <div class="box">
                <a href="<?php echo e(url('product.show', $product->id)); ?>">
                  <div class="img-box">
                  ...
                  <div class="detail-box">
                    <h6 class="prodName"><?php echo e($product->name); ?></h6>
                    <div class="d-flex justify-content-between">
                      <h6 style="color:gray;">
                        Price
                        <span style="color:gray;">BTC<?php echo e($product->price); ?></span>
                      </h6>
    ...
    <div class="container">
      ...
      <div class="d-flex">
        ...
        <div class="container-row card-outerSecond"style="gap:20px;">
          <?php $__currentLoopData = $vehcles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="">
              <div class="box">
                <a href="<?php echo e(url('product.show', $product->id)); ?>">
                  <div class="img-box">
  ...
  <section class="shop_section layout_padding">
    <div class="container">
      ...
      <div class="d-flex justify-content-center align-items-center" style="margin-right:7px;">
        ...
        <?php $__currentLoopData = $reallestate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div>
            <div class="box">
              <a href="<?php echo e(url('product.show', $product->id)); ?>">
                <div class="img-box">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="box ">
            <div class="img-box">
              <img src="<?php echo e(url('front_assets/images/one.jpg')); ?>" style="height: 240px; width: 320px;" alt="Description of the image">
            </div>
...
<?php /**PATH C:\xampp\htdocs\marketPlace-main\resources\views/welcome.blade.php ENDPATH**/ ?>